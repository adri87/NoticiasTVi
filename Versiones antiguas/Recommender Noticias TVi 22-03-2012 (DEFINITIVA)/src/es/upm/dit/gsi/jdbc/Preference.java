...
public class Preference {
	...
	private static Logger LOGGER = Logger.getLogger("jdbc.Preference");
	...
	/**
	 * Nos indica da la valoración que un usuario ha dado a un contenido.
	 * 
	 * @param userId
	 * @param contentId
	 * @return true or false
	...
	/**
	 * Nos devuelve el número de votos que ha recibido un determinado contenido.
	 * 
	 * @param contentId
	 * @return numVotes
	 */
	...
	public static void removePreferencesUser (long userId){
		try {
			...
			prepStmt.setLong(1, userId);
	    	prepStmt.execute();
	    	LOGGER.info("Se han eliminado todas las valoraciones que había realizado el usuario");
	    } catch (Exception e) {
	    	e.printStackTrace();
	    }
	}
